...
COLUMN_ALIASES: dict[str, list[str]] = {
    ...
    "desired_locations": ["desired_locations", "希望勤務地", "勤務地"],
    "desired_other": ["desired_other", "その他の希望", "その他希望"],
...
def row_to_candidate(row: dict[str, str], index: dict[str, str]) -> Candidate | None:
    ...
    return Candidate(
        ...
        desired_locations=g("desired_locations"),
        desired_other=g("desired_other"),
        summary=g("summary"),
